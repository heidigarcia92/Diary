    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    text1 = new wxStaticText(this, wxID_ANY, _("Static Text Label"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    flexGridSizer17->Add(text1, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, WXC_FROM_DIP(5));
    
    text2 = new wxStaticText(this, wxID_ANY, _("Static Text Label"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    
    flexGridSizer17->Add(text2, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, WXC_FROM_DIP(5));
    
    text3 = new wxStaticText(this, wxID_ANY, _("Static Text Label"), wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1,-1)), 0);
    ...
    list3->Connect(wxEVT_COMMAND_LIST_COL_DRAGGING, wxListEventHandler(MainFrameBaseClass::onDrag), NULL, this);
    list3->Connect(wxEVT_COMMAND_LIST_KEY_DOWN, wxListEventHandler(MainFrameBaseClass::onKeyDown), NULL, this);
...
MainFrameBaseClass::~MainFrameBaseClass()
{
    ...
    list3->Disconnect(wxEVT_COMMAND_LIST_COL_DRAGGING, wxListEventHandler(MainFrameBaseClass::onDrag), NULL, this);
    list3->Disconnect(wxEVT_COMMAND_LIST_KEY_DOWN, wxListEventHandler(MainFrameBaseClass::onKeyDown), NULL, this);
